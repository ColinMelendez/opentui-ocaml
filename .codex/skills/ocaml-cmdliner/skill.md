---
name: cmdliner
description: "Designing and implementing robust command-line interfaces using OCaml's cmdliner library, following Daniel Bünzli's design principles. Use when you need to: (1) Design a new CLI or subcommand layout, (2) Implement cmdliner terms and combinators, (3) Produce high-quality --help output and error messages, (4) Integrate cmdliner CLIs into dune-based OCaml projects."
license: ISC
metadata:
...
cmdliner is a library for defining declarative CLIs.
...
3. **Orthogonality**
   - Each flag controls one independent aspect of behavior.
...
Keep explanations concrete and focused on practical trade-offs (naming, grouping of options, error behavior, and output formats).
