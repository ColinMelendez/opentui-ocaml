...
| New native concurrent I/O | Eio | Feature-complete direct-style effects library: structured concurrency, io_uring on Linux, real backtraces. Generally the best and default choice. |
