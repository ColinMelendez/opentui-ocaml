---
name: ocaml-eio
description: "Eio concurrency patterns for OCaml applications. Use when you need to plan designs around using Eio. Usual usages include: (1) Write concurrent OCaml code with Eio, (2) Handle network operations, (3) Manage resource lifecycles with switches, (4) Implement rate limiting or synchronization, (5) Create parallel operations with fibers, (6) Test async code with Eio_mock, (7) Integrate with bytesrw for streaming, or any other Eio-based concurrency tasks"
license: ISC
metadata:
