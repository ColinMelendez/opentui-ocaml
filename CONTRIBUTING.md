...
| <code>core/src/renderer.ts</code> | <code>docs/major-features/in-progress/renderable-core/feature.md</code>; <code>docs/major-features/in-progress/renderer-presentation/feature.md</code>; target <code>packages/opentui-core/src/renderer.ml</code> and <code>packages/opentui-core/src/platform/</code> | Keep invalidation, frame requests, explicit rendering, presentation, and any scheduler or output-backpressure policy distinct. Renderer-owned background color and terminal cursor presentation forward to native; Eio may replace the scheduling mechanism, but an explicit render boundary must not be described as the reference scheduler itself. |
