...
## Preserved investigation body (retired)

The unlit-triangle draw-test body that lived here landed for real in
slice B (test_wgpu_headless.ml); the standalone C probe survives as
Wgpu.debug_triangle for regression comparison. Full text is in git
