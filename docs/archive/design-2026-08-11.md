...
> Archived on 2026-08-11. The current structural contract is in
> [`docs/architecture.md`](../architecture.md); this file records the design
> before the source-tree migration.
...
[`renderable-architecture.md`](renderable-architecture-2026-08-11.md).
