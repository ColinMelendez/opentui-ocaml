...
| `bufferDrawBox` | `lib.zig:1443` | `u32, i32, i32, u32, u32, pointer to 11 u32 code points, u32, three color pointers, two nullable byte pointer/u32 pairs -> void` | Border code points, colors, and optional title strings are borrowed for the synchronous draw. The origin is signed; dimensions are nonnegative. |
